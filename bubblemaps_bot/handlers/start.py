...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """
    Telegram command to welcome users and add them to the database.
    Usage: /start
    """
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """
    Telegram command to display detailed help text with available commands.
    Usage: /help
    """
...
def get_handlers():
    """
    Return handlers for the start and help commands.
    """
